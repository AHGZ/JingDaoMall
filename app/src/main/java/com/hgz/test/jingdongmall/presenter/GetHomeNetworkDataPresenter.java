...
public class GetHomeNetworkDataPresenter extends BasePresenter<IGetHomeNetworkDataView>{

    private GetHomeNetworkDataModel getShouyeNetworkDataModel;

    public GetHomeNetworkDataPresenter(IGetHomeNetworkDataView iView) {
        super(iView);
    }

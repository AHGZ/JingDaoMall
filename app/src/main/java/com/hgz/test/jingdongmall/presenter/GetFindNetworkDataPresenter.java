...
public class GetFindNetworkDataPresenter extends BasePresenter<IGetHomeNetworkDataView>{

    private GetHomeNetworkDataModel getShouyeNetworkDataModel;

    public GetFindNetworkDataPresenter(IGetHomeNetworkDataView iView) {
        super(iView);
    }
